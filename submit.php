...
require("mailer/PHPMailerAutoload.php");
            ...
            $mail->Subject = "Kingstar Internet";
            $mail->Body = "<html>
            <head>
            ...
            <tr>
            <th style='border: 1px solid black; border-collapse: collapse;'>Plan</th>
            <td style='border: 1px solid black; border-collapse: collapse; text-align: center;'>".$services."</td>
            </tr>
            <tr>
            ...
            $mail->AddAddress("kaushal.netcron@outlook.com");
